    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      <div className="relative group">
        <a
          ...
          className="bg-green-700 hover:bg-green-800 text-white rounded-full h-14 w-14 flex items-center justify-center shadow-lg transition duration-300 overflow-hidden"
          target="_blank"
        ...
        <button
          ...
          className={`absolute -top-3 -left-3 bg-amber-600 hover:bg-amber-700 text-white rounded-full h-7 w-7 flex items-center justify-center shadow-md transition-all duration-300 ${
