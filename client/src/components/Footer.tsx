          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-600">
                Contact us today for quality products and competitive pricing
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              >
                <img
                  src={whatsappIcon}
                  alt="WhatsApp"
                  className="w-8 h-8 object-contain text mr-2"
                />
                WhatsApp Chat
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Premium building materials supplier serving the construction
                industry since 2008 with quality products and reliable service
                nationwide.
              </p>
              ...
              <div className="flex space-x-3">
                <a
                  href="#"
                  className="bg-gray-700 hover:bg-gray-600 h-10 w-10 rounded-full flex items-center justify-center transition-colors duration-300"
                >
                  <span className="material-icon">facebook</span>
                </a>
                <a
                  href={`https://wa.me/${contactInfo.whatsapp}`}
                  className="bg-green-700 hover:bg-green-600 h-10 w-10 rounded-full flex items-center justify-center transition-colors duration-300"
                >
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  ...
                  >
                    <span className="material-icon mr-2 text-amber-500 text-xs">
                      navigate_next
                    </span>
                    Home
                  </a>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    ...
                    className="text-gray-300 hover:text-white flex items-center transition-colors duration-300"
                  >
                    <span className="material-icon mr-2 text-amber-500">
                      beach_access
                    </span>
                    Premium Sand
                  </a>
                ...
                <li>
                  <a
                    ...
                    className="text-gray-300 hover:text-white flex items-center transition-colors duration-300"
                  >
                    <span className="material-icon mr-2 text-gray-400">
                      grain
                    </span>
                    Stone & Aggregates
                  </a>
                ...
                <li>
                  <a
                    ...
                    className="text-gray-300 hover:text-white flex items-center transition-colors duration-300"
                  >
                    <span className="material-icon mr-2 text-red-400">
                      view_in_ar
                    </span>
                    Limestone Products
                  </a>
                ...
                <li>
                  <a
                    ...
                    className="text-gray-300 hover:text-white flex items-center transition-colors duration-300"
                  >
                    <span className="material-icon mr-2 text-amber-400">
                      construction
                    </span>
                    Construction Tools
                  </a>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex">
                  <span className="material-icon mr-3 text-amber-500 mt-1">
                    location_on
                  </span>
                ...
                <li className="flex">
                  <span className="material-icon mr-3 text-green-400 mt-1">
                    access_time
                  </span>
                ...
                <li className="flex items-center">
                  <span className="material-icon mr-3 text-amber-500">
                    phone
                  </span>
                  <a
                    href={`tel:${contactInfo.phone.sales.replace(
                      /[^0-9+]/g,
                      ""
                    )}`}
          ...
          <div className="pt-8 border-t border-gray-700">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm mb-4 md:mb-0">
                &copy; {new Date().getFullYear()} Retiwala Building Materials.
                All rights reserved.
              </p>
